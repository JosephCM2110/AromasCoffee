...
<html lang="en">
    ...
    <body class="nav-md">
        ...
        $imageBusiness = new ImagesProductAdminBusiness();
        $result = $imageBusiness->getAllTBImageProducts();
        ?>
        <!-- page content -->
                                        ...
                                        <div class="col-md-55">
                                            <div class="thumbnail">
                                                <div class="image view view-first">
                                                    <img style="width: 100%; display: block;" src="../Resources/ImagesProducts/<?php echo $currentImage->getImagePath(); ?>" alt="image" />
                                                    <div class="mask">                                                        
                                                        <div class="tools tools-bottom">                                                            
                                                            <button style="background: #000;" onclick="deleteImageProduct('<?php echo $currentImage->getIdImageProduct(); ?>','<?php echo $currentImage->getImagePath();?>')"><i class="fa fa-trash-o"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="caption">
                                                    <p><?php echo $currentImage->getProduct(); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <?php
