            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Agregar imágenes galería</h2>
                            ...
                            <div class="x_content">
                                <p>Arrastre varios archivos al cuadro de abajo para cargar múltiples o haga clic para seleccionar archivos. <span>Los archivos se cargarán automáticamente</span></p>
                                <form action="../BusinessAdmin/NewImagesGalery.php" class="dropzone"></form>
                                <br />
                                <br />
                                <br />
                                <br />
