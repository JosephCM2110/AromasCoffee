    ...
    <body class="login">
            ...
            <div class="login_wrapper">
                <div class="animate form login_form">
                    <section class="login_content">
                        <form id="frmLogin" method="POST" action="../BusinessAdmin/AdministratorAction.php">
                            <h1>Inicio Sesión</h1>
                            <div>
        ...
        if (isset($_GET['errorE'])) {
            ...
            $(document).ready(function(){
                modalSelect("¡El usuario no se encuentra registrado!","Error");
                $("#myModal").modal("show");
            });
        </script>';
            ...
            echo '<script>                
            $(document).ready(function(){
                modalSelect("¡Los datos ingresados no son válidos!","Error");
                $("#myModal").modal("show");
            });
        </script>';
        }
